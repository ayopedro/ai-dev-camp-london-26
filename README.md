# AI Dev Camp London 26 🚀

This repository contains various agentic AI projects built during the Google AI Dev Camp in London.
...
- **Gemini 2.5 Flash**: High-performance LLM orchestration.
- **TypeScript**: Robust, type-safe agent logic.
- **Python**: agent logic and tools.

---
*Developed by me during AI Dev Camp 2026.*
